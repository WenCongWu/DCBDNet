...
parser.add_argument('--input_dir', default='./Datasets/Nam/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/Nam/', type=str, help='Directory for results')
