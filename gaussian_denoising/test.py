...
def main():
    ...
    model_name = 'DCBDNet_color'           # set denoiser model, 'DCBDNet_gray' | 'DCBDNet_color'
    testset_name = 'Kodak24'               # set test set,  'BSD68' | 'CBSD6868' | 'Set12'
    ...
    from models.network import DCBDNet as net
    model = net(in_nc=n_channels, out_nc=n_channels, nc=[48, 64], bias=False)
